...
# ⚙️ CONFIGURAÇÃO DE SENHA - LEIA ISTO:
# Por padrão, o script usa a senha do arquivo .env
# Se você precisar usar uma senha DIFERENTE temporariamente, descomente a linha abaixo:
# OVERRIDE_PASSWORD = "SuaSenhaTemporariaAqui"
# -*- coding: utf-8 -*-
"""
HCPIF extractor R2.7.4
Changes vs R2.7.3:
...
ORACLE_CLIENT_DIR = os.getenv("ORACLE_CLIENT_DIR", r"C:\Users\josenjr\OneDrive - Expedia Group\Desktop\Oracle Instant Client\instantclient_23_0")
ORACLE_USERNAME = os.getenv("ORACLE_USERNAME", "josenjr")
ORACLE_PASSWORD = os.getenv("ORACLE_PASSWORD")  # Loaded from .env
ORACLE_DSN = os.getenv("ORACLE_DSN", "ashworaebsdb02-vip.datawarehouse.expecn.com:1526/ORAPRD_UI")

# Aplica override se estiver definido
if 'OVERRIDE_PASSWORD' in locals():
    ORACLE_PASSWORD = OVERRIDE_PASSWORD
    print("⚠️  ATENÇÃO: Usando senha OVERRIDE ao invés do .env")
    print(f"   Senha do .env foi IGNORADA - usando senha manual de {len(OVERRIDE_PASSWORD)} caracteres")
else:
    print(f"✓ Usando credenciais do .env (senha com {len(ORACLE_PASSWORD or '')} caracteres)")
